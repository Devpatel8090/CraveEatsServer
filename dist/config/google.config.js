...
function _asyncToGenerator(n) { return function () { var t = this, e = arguments; return new Promise(function (r, o) { var a = n.apply(t, e); function _next(n) { asyncGeneratorStep(a, r, o, _next, _throw, "next", n); } function _throw(n) { asyncGeneratorStep(a, r, o, _next, _throw, "throw", n); } _next(void 0); }); }; } // all startegies for google authentication. passport is only for authentication but we are using the google auth so we are using the google passport libarary to make it easier.
var GoogleStrategy = _passportGoogleOauth["default"].Strategy;
var _default = exports["default"] = function _default(passport) {
  passport.use(new GoogleStrategy({
    ...
    function () {
      var _ref = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee(accessToken, refreshToken, profile, done) {
        var newUser, user, token, _user, _token, _t;
        return _regenerator().w(function (_context) {
          while (1) switch (_context.n) {
            case 0:
              ...
              _context.p = 1;
              _context.n = 2;
              return _allModelsIndex.UserModel.findOne({
                email: newUser.email
              });
            case 2:
              user = _context.v;
            ...
            case 3:
              _context.n = 4;
              return _allModelsIndex.UserModel.create(newUser);
            case 4:
              _user = _context.v;
              // generate token
