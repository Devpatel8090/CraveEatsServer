...
var _default = exports["default"] = function _default(passport) {
  passport.use(new JWTStrategy(options, /*#__PURE__*/function () {
    var _ref = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee(jwt_payload, done) {
      var doesUserExist, _t;
      return _regenerator().w(function (_context) {
        while (1) switch (_context.n) {
          case 0:
            _context.p = 0;
            _context.n = 1;
            return _allModelsIndex.UserModel.findById(jwt_payload.user);
          case 1:
            doesUserExist = _context.v;
            if (doesUserExist) {
              _context.n = 2;
              break;
            }
          ...
          case 2:
            return _context.a(2, done(null, doesUserExist));
          case 3:
            _context.p = 3;
            _t = _context.v;
            throw new Error(_t);
