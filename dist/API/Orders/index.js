...
var _orderModel = require("../../database/order/orderModel");
var _validateUser = _interopRequireDefault(require("../../config/validateUser.config"));
...
Router.get("/:_id", _passport["default"].authenticate("jwt"), _validateUser["default"], /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee(req, res) {
    var _id, getOrders, _t;
    return _regenerator().w(function (_context) {
      while (1) switch (_context.n) {
        case 0:
          ...
          _id = req.params._id;
          _context.n = 1;
          return _orderModel.OrderModel.findOne({
            user: _id
          });
        case 1:
          getOrders = _context.v;
          if (getOrders) {
            _context.n = 2;
            break;
          }
...
Router.post("/new/:_id", _passport["default"].authenticate("jwt"), _validateUser["default"], /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee2(req, res) {
    var _id, orderDetails, addNewOrder, _t2;
    return _regenerator().w(function (_context2) {
      while (1) switch (_context2.n) {
        case 0:
          ...
          _context2.n = 1;
          return _orderModel.OrderModel.findOneAndUpdate({
            user: _id
          }, {
            $push: {
