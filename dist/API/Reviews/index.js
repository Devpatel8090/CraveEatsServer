    ...
    return _regenerator().w(function (_context) {
      while (1) switch (_context.n) {
        case 0:
          ...
          _context.n = 1;
          return _allModelsIndex.ReviewModel.find({
            restaurant: resid
          }).populate("user", "fullName").populate("food", "name");
        case 1:
          Reviews = _context.v;
          console.log(Reviews);
...
Router.post("/new", _passport["default"].authenticate("jwt"), /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee2(req, res) {
    var _id, reviewData, Reviews, _t2;
    return _regenerator().w(function (_context2) {
      while (1) switch (_context2.n) {
        case 0:
          ...
          _context2.n = 1;
          return _allModelsIndex.ReviewModel.create(_objectSpread(_objectSpread({}, reviewData), {}, {
            user: _id
          }));
        case 1:
          Reviews = _context2.v;
    ...
    return _regenerator().w(function (_context3) {
      while (1) switch (_context3.n) {
        case 0:
          ...
          _id = req.params._id;
          _context3.n = 1;
          return _allModelsIndex.ReviewModel.findByIdAndDelete(_id);
        case 1:
