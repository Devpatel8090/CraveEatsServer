...
Router.get("/", _passport["default"].authenticate("jwt"), /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee(req, res) {
    var _req$session$passport, email, fullName, phoneNumber, address, _t;
    ...
    return _regenerator().w(function (_context2) {
      while (1) switch (_context2.n) {
        case 0:
          ...
          _id = req.params._id;
          _context2.n = 1;
          return _allModelsIndex.UserModel.findById(_id);
        case 1:
          getUser = _context2.v;
          user = getUser.user;
          if (getUser) {
...
Router.put("/update/:userId", /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee3(req, res) {
    var userId, userData, updateUserData, _t3;
    return _regenerator().w(function (_context3) {
      while (1) switch (_context3.n) {
        case 0:
          ...
          _context3.n = 1;
          return _allModelsIndex.UserModel.findByIdAndUpdate(userId, {
            $set: userData
          }, {
            "new": true
          });
        case 1:
          updateUserData = _context3.v;
