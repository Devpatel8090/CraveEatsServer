...
// used for uploding the image by using the RAM for temporary purpose of that instance
// Database Modal
    ...
    return _regenerator().w(function (_context) {
      while (1) switch (_context.n) {
        case 0:
          ...
          _id = req.params._id;
          _context.n = 1;
          return _allModelsIndex.ImageModel.findById(_id);
        case 1:
          image = _context.v;
          return _context.a(2, res.status(200).json(image));
        case 2:
          _context.p = 2;
          _t = _context.v;
...
Router.post("/", upload.array("file", 4), /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee2(req, res) {
    var file, bucketOptions, uploadImage, saveImageToDatabase, _t2;
    return _regenerator().w(function (_context2) {
      while (1) switch (_context2.n) {
        case 0:
          _context2.p = 0;
          file = req.files; // S3 bucket options
          bucketOptions = {
        ...
        case 1:
          uploadImage = _context2.v;
          _context2.n = 2;
          return _allModelsIndex.ImageModel.create({
            images: [{
              Location: uploadImage.Location
            }]
          });
        case 2:
          saveImageToDatabase = _context2.v;
