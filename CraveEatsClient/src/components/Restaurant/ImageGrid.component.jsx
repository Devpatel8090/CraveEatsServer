    ...
    return (
        <>
            ...
            <div className="w-full h-60 md:hidden">
                <img
                    src={props.images.length > 0 ? props.images[0].Location : "https://aadhya-restaurant-bucket.s3.us-west-1.amazonaws.com/No+image+Availble.png"}
                    alt="restaurnat"
            ...
            <div className="hidden w-full h-96 md:flex gap-1">
                ...
                <div className="w-1/4 h-full flex flex-col gap-1 overflow-hidden">
                    <div className="w-full h-2/4 overflow-hidden rounded-lg">
                        <img
                            src={props.images.length > 0 ? props.images[1].Location : "https://aadhya-restaurant-bucket.s3.us-west-1.amazonaws.com/No+image+Availble.png"}
                            alt="restaurant"
                    ...
                    <div className="w-full h-2/4 overflow-hidden rounded-lg">
                        <img
                            src={props.images.length > 0 ? props.images[2].Location : "https://aadhya-restaurant-bucket.s3.us-west-1.amazonaws.com/No+image+Availble.png"}
                            alt="restaurant"
                ...
                <div className="w-1/4 h-full flex flex-col gap-1 overflow-hidden">
                    <div className="w-full h-2/4 relative">
                        <img
                            src={props.images.length > 0 ? props.images[3].Location : "https://aadhya-restaurant-bucket.s3.us-west-1.amazonaws.com/No+image+Availble.png"}
                            alt="restaurant"
                    ...
                    <div className="w-full h-2/4 relative ">
                        <img
                            src={props.images.length > 0 ? props.images[4].Location : "https://aadhya-restaurant-bucket.s3.us-west-1.amazonaws.com/No+image+Availble.png"}
                            alt="restaurant"
                            className="w-full h-full object-cover rounded-lg"
                        />
                        <div className="absolute inset-0 bg-opacity-40 bg-black w-full h-full rounded-lg" />
